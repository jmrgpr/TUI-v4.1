...
- Do not read `data/`, generated `results/`, `reports/`, `plots/`, `htmlcov/`, `.venv/`, caches, run logs, binary documents, PDFs, images, or generated experiment artifacts unless the user explicitly asks for that evidence.
