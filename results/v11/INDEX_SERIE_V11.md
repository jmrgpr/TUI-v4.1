...
- **Organizador (raw → canónico):** `scripts/organize_F6_results.py`
- **Análisis preregistrado (endpoint CFR + McNemar + Holm):** `scripts/f6_preregistered_analysis_v11.py`
...
- **Outputs canónicos:** `results/v11/RV2/rv2_run_metrics.csv` y `results/v11/RV2/rv2_invariants.json`

### I) "Quiero ejecutar F7 (budget calibration para CFR)"
- **Preregistro (canónico):** `results/v11/F7/PREREGISTRO_F7_v11.md`
- **Log de desviaciones:** `results/v11/F7/F7_DEVIATIONS_LOG_v11.md`
- **Cierre:** `results/v11/F7/F7_CLOSURE_REPORT.md`
- **Runner (piloto/select/confirm):** `results/v11/F7/run_F7_v11.py`
