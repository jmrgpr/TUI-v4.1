...
Este directorio contiene salidas crudas generadas por `results/v11/F5/run_F5_v11.py`:

- JSON agregados por run (incluyen `control` + `simbiosis`).
...
1) Ejecuta `python scripts/organize_F5_results.py` para generar la estructura canónica por agente en `results/v11/F5/F2_redteam/...`.
